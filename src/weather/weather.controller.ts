...
export class WeatherController {
        ...
        value: {
          ...
          data: {
            location: {
              ...
              lon: 73.8667,
              tz_id: 'Asia/Kolkata',
              localtime_epoch: 1739699786,
              localtime: '2025-02-16 15:26',
            },
            current: {
              last_updated_epoch: 1739699100,
              last_updated: '2025-02-16 15:15',
              temp_c: 33.2,
              temp_f: 91.7,
              feelslike_c: 31.1,
              feelslike_f: 87.9,
  ...
  ): Promise<HttpApiResponse<CurrentWeatherDataDto>> {
    if (!city) {
      throw new BadRequestException('City parameter is required');
    }
    const data = new CurrentWeatherDataDto(
