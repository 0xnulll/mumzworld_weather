    ...
    it('should return weather data for a valid city', async () => {
      ...
      const testData = {
        location: {
          ...
          lon: 73.8667,
          tz_id: 'Asia/Kolkata',
          localtime_epoch: 1739628114,
          localtime: '2025-02-15 19:31',
        },
        current: {
          last_updated_epoch: 1739628000,
          last_updated: '2025-02-15 19:30',
          temp_c: 27.2,
          temp_f: 80.9,
          is_day: 0,
          condition: {
      ...
      expect(await weatherController.getWeather(city)).toEqual({
        success: true,
        data: new CurrentWeatherDataDto(testData),
      });
    });
  });
});
