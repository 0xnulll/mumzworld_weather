...
describe('ForecastController', () => {
  ...
  describe('getForecast', () => {
    it('should throw BadRequestException if city is not provided', async () => {
      await expect(forecastController.getForecast('')).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should return Forecast data for a valid city', async () => {
      ...
      const testData = {
        location: {
          ...
          lon: 73.8667,
          tz_id: 'Asia/Kolkata',
          localtime_epoch: 1739630862,
          localtime: '2025-02-15 20:17',
        },
        current: {
          last_updated_epoch: 1739630700,
          last_updated: '2025-02-15 20:15',
          temp_c: 25.9,
          temp_f: 78.7,
          is_day: 0,
          condition: {
      ...
      expect(await forecastController.getForecast(city)).toEqual({
        success: true,
        data: new ForecastDataDto(testData),
      });
    });
  });
});
